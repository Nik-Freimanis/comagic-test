        ...
        <section className={s.btnSection}>
            <div className={s.btnSection__container}>
                <div className={s.btnSection__container_content}>
                    ...
                    <p>Разработчик должен создать функциональный компонент кнопки с текстовым содержимым, который меняет цвет при нажатии. Кнопка должна иметь возможность менять текст и стили. </p>
